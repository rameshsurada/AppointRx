...
const Header = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 py-10 md:px-10 lg:px-20">
      {/* left side section  */}
      <div className=" md:w-1/2 flex flex-col items-start justify-center gap-4 py-10   m-auto mdpy-[10vw] md:mb -[-30px]">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
          ...
          <p>
            {" "}
            Simply browse through our ectensive list of truested doctors,{" "}
